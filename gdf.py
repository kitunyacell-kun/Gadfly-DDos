...
▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒""")
print(f"\033[97m╔{'═' * 66}╗")
print(f"\033[97m║\033[104m{' ' * 20}Don't attack government sites{' ' * 17}\033[0m║")
print(f"\033[97m║\033[104m{' ' * 19}Just to fight to help Palestine{' ' * 16}\033[0m║")
print(f"\033[97m║\033[104m{' ' * 27}_Use it wisely_{' ' * 24}\033[0m║")
print(f"\033[97m╚{'═' * 66}╝")
while attemps < 100:
